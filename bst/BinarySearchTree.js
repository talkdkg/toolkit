/* Binary Search Tree by Kyle Dinh
 * usage: var bst = new BinarySearchTree();
 * bst.put(key, val);
 * bst.get(key);
 * bst.delete(key);
 */
...
BinarySearchTree.prototype = {
   ...
   //PRIVATE methods
   append: function (_key, _value, _current) {
